...
Don't look for someone who will solve your problems. Look for someone who will
face them with you
-- Anonymous

Only a fool ignores the truth because he doesn't lke the messenger
-- Anonymous

A certain amount of opposition is a help, not a hindrance. Kites rise against
...
Be who you are, say what you mean because those who mind don't matter and those
...
The thing with broken clocks is you can always tell exactly when they stopped
ticking, with people it isn't so easy and sometimes you can't even tell they're
broken
-- Anonymous

If someone does not want me it is not the end of the world, but if I do not want
me, the world is nothing but endings
-- Nayyirah Waheed, "salt."

Where you are is not who you are
-- Nayyirah Waheed, "salt."

The power of accurate observation is often called cynicism by those who have not
got it.
-- George Bernard Shaw

Everyone you meet has a part to play in our story. And while some may take a
chapter, others a paragraph, and most will be no more than scribbled notes in
the margins, someday, you'll meet someone who will become so integral to your
life, you'll put their name in the title.
-- Beau Taplin

Be brave, my darling, you have faced dark times before and you're still here
-- Chris Lees

Your rights matter because you never know when you're going to need them.
-- Edward Snowden

No monumental evil act in the history of mankind has been committed by anyone
who thought of themselves as "evil" — on the contrary, the worse the (objective)
evil, the more the perpetrator was completely convinced of the goodness of
himself and of his "purification"
-— Eric Naggum
...
Security is mostly a superstition. Avoiding danger is no safer in the long run
than outright exposure. Life is either a daring adventure, or nothing
-— Helen Keller

A superior pilot uses his superior judgment to avoid having to exercise his
superior skill
-— Frank Borman
...
trying to adapt the world to himself. All progress, therefore, depends upon the
unreasonable man
-— George Bernard Shaw
...
that's offensive to another person you just caused a discussion. You just forced
...
what they want. That’s a far more depressing thought.
-— Steve Jobs

Be kind, for everyone is fighting a hard battle
-— Ian MacLaren

Morality is doing what’s right regardless of what you’re told. Obedience is
doing what you’re told regardless of what is right
-- Anonymous

Eventually, I decided that thinking was not getting me very far and it was time
to try building
-— Rob Pike
...
No dream is guaranteed, the grace of age is when we learn to accept
-- Farscape, "Crichton Kicks"

Nothing adds excitement like something that is none of your business
-- Anonymous

A dog is carrying a bone, and comes to a stream where it sees it's own
reflection. Mistaking it for a dog with a better bone, it barks, hoping the
"other" dog will drop it's bone. But in doing so, the dog drops it's own bone,
where it sinks to the bottom of the water. If the dog is smart enough to learn,
if it could have had only one bone, which would it have wanted?
-- Aesop's Fables, "The Dog and its Reflection"
...
Sometimes they pretrend to be your friend first.
-- Steve Irwin
...
When thinking about life, remember this: no amount of guilt can change the
past and no amount of anxiety can change the future.
-- Anonymous
...
There are good ships, wood ships, ships that sail the seas; but the best ships
...
# Hackish trickery to get shuf to pick a group seperated "\n\n" (an empty line)
# instead of the default "\n" (new line) as a element seperator.
#
# sed is mixed with tr, because tr searches by char not a complete string
# You could probably just use sed, but I doubt it would be very readable.
RAND_QUOTE=$(tr "\n" "\r" <<< "$QUOTES" | sed 's/\r\r/\n/g' | shuf -n1 | tr "\r" "\n")


# Last line is always the author, so split it off so it can be pretty printed
# Otherwise, you could just echo $RAND_QUOTE if you care more about speed vs formatting
head -n -1 <<< "$RAND_QUOTE"
